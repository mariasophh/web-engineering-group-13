...
const initSongs = () => {
    ...
    Database.createTable(
        TABLE,
        'ID CHAR PRIMARY KEY, RELEASE_ID INT, HOTTNESS FLOAT, TITLE INT, YEAR INT, ARTIST_MBTAGS FLOAT, ARTIST_MBTAGS_COUNT FLOAT, BARS_CONFIDENCE FLOAT, BARS_START FLOAT, BEATS_CONFIDENCE FLOAT, BEATS_START FLOAT, DURATION FLOAT, END_OF_FADE_IN FLOAT, KEY FLOAT, LOUDNESS FLOAT, KEY_CONFIDENCE FLOAT, MODE INT, MODE_CONFIDENCE FLOAT, START_OF_FADE_OUT FLOAT, TATUMS_CONFIDENCE FLOAT, TATUMS_START FLOAT, TEMPO FLOAT, TIME_SIGNATURE FLOAT, TIME_SIGNATURE_CONFIDENCE FLOAT'
    );
